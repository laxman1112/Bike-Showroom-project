					...
					<div class="row">
						...
						<table class="table">
							...
							<tr>
								...
								<td><a
									href="AddAccessoriesDetails?id=<%=accessories.getaId()%>&bid=<%=accessories.getBikeId()%>">Remove</a></td>
							</tr>
							<%
								}
												if(i0<=0)
			...
			<div class="col-lg-5">
				<div class="bordered-div">
					...
					<div class="table-responsive">
						<form action="AddAccessoriesDetails" method="post">
							<table class="table">
								<tr>
									<th>Acceesseries Name</th>
									<td><input type="hidden" name="bike_id"
										value="<%=request.getParameter("bid")%>"> <input
										type="text" class="form-control" name="accessories_name"
