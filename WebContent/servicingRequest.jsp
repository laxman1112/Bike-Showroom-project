...
<body>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<div class="col-lg-6">
				<img alt="" src="img/servicing.gif">
			</div>
			<div class="col-lg-6">
				<h2 align="center" style="color: purple;">Servicing Request
					Details</h2>
				<hr />
				<div class="table-responsive">
					<form action="SendServicingRequest" method="post">
						<!-- Specify your backend script for form submission -->
						<table class="table">

							<tr>
								<td>Appoinment Date</td>
								<th><input type="date" class="form-control" required
									name="app_date" required></th>
							</tr>
							<tr>
								<td>Bike Number</td>
								<th><input type="text" class="form-control" required
									name="bike_number" required></th>
							</tr>
							<tr>
								<th>Vehicle Issue:</th>
								<th><textarea name="vehicel_issue" class="form-control"
										rows="" cols="" required></textarea></th>
							</tr>
							<tr>
								<th></th>
								<th><button type="submit" class="btn btn-success">Send
										Servicing Request</button></th>
							</tr>
