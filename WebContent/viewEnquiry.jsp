...
<body>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h1 style="color: purple;" align="center">View New Enquiry</h1>
			<div class="col-lg-12">
				<hr />
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<%
							...
							PreparedStatement ps =con.prepareStatement("SELECT * FROM `selling_details` ORDER BY s_id DESC");
							...
							while(rs.next())
							{
								...
								HashMap<String,String> custDetails=gf.getCustomerDetails(c_id);
						...
						<tbody>
							<tr>
								...
								<td><%=custDetails.get("c_name") %></td>
								<td><%=custDetails.get("gender") %></td>
								<td><%=custDetails.get("mobile") %></td>
								<td><%=custDetails.get("email") %></td>
								<td><%=custDetails.get("address") %></td>
								<td><%=custDetails.get("acc_cdatetime") %></td>
							</tr>
						</tbody>
						<%
							}
