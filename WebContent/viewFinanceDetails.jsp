...
<body>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h1 style="color: purple;" align="center">View Finance Details</h1>
			<div class="col-lg-12">
				<hr />
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<%
							...
							PreparedStatement ps =con.prepareStatement("SELECT * FROM `financial_details` where status='Available'");
							...
							HashMap<String,String> financeDetails=gf.getFinanceDetails(f_id);
						%>
						...
						<tbody>
							<tr>
								...
								<td><%=financeDetails.get("finance_duration")%></td>
								<td><%=financeDetails.get("rate_intrest")%></td>

								<td>
									<%
										if(financeDetails.get("status").equals("Available"))
																					{
									%> <a style="color: red;" href="UpdateInsurance?id=<%=f_id%>">Remove</a>
									<%
										}
									%>
								</td>
