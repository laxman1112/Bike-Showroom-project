...
<body>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h1 style="color: purple;" align="center">View Test Ride Request
				Details</h1>
			<div class="col-lg-12">
				<hr />
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<%
							...
							PreparedStatement ps =con.prepareStatement("SELECT * FROM `riding_request`");
							...
							HashMap<String,String> custDetails=gf.getCustomerDetails(cust_id);
						...
						<tbody>
							<tr>
								...
								<td>Customer Name: <%=custDetails.get("c_name")%><br />
									Gender :<%=custDetails.get("gender")%><br /> Mobile: s<%=custDetails.get("mobile")%><br />
									Email ID : <%=custDetails.get("email")%><br /> Address : <%=custDetails.get("address")%><br /></td>
								...
								{
								%> <a style="color: red;"
									href="UpdateTestRideRequest?rrid=<%=rr_id%>&sts=a">Accept</a>&nbsp;|&nbsp;<a
									style="color: red;"
									href="UpdateTestRideRequest?rrid=<%=rr_id%>&sts=r">Reject</a> <%
								}
								%>
								</td>
							</tr>
