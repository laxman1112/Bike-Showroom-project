				...
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<%
							...
							PreparedStatement ps = con.prepareStatement("SELECT * FROM `servicing_request`");
						...
						<tbody>
							<tr>
								...
								{
								%> <a style="color: red;"
									href="UpdateServicingRequest?sid=<%=rs.getString("sreq_id")%>&sts=a">Accept</a>&nbsp;|&nbsp;<a
									style="color: red;"
									href="UpdateServicingRequest?sid=<%=rs.getString("sreq_id")%>&sts=r">Reject</a>
									<%
								}
								%>
								</td>
