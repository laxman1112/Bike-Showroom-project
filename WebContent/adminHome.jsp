...
<body>
			...
			<div class="row">
				<div class="col-lg-8 col-sm-8 col-7">
					<ul class="info">
						...
						<li><a href="#"><i class="fa fa-phone"></i>+91 7823058871</a></li>
					</ul>
				</div>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h1 align="center" style="color: purple;">Welcome Admin</h1>
			<br /> <img alt="" src="img/banner2.png">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<p>
					Copyright © 2024
					<jsp:include page="projectTitle.jsp" />.
				</p>
			</div>
		</div>
	</div>
