			...
			<div class="col-lg-6">
				<div class="bordered-div">
					<div class="row">
						...
						<%
						if(session.getAttribute("u_type").toString().equals("Customer"))
						{
						%>
						<table class="table">
							<tr>
								<td><a href="TestRideRequest?bid=<%=b_id%>">Request for
										Test Ride</a></td>
								<td><a href="AddToCart?bid=<%=b_id%>&sts=ac">ReadyForPurchase</a>
								<!-- <i class='fas fa-heart' style='font-size:30px;color:red'></i> --></td>
							</tr>
							<%
							}
							%>
