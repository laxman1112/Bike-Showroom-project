					...
					<div class="row">
						...
						<table class="table">
							...
							<tr>
								...
								<td><%=staffDetails.get("staff_name")%><br /> Mb.<%=staffDetails.get("mobile")%>
								</td>
							</tr>
							<%
								}
						...
						<h6 style="color: purple;">Insurance Details</h6>
						<table class="table">
							<tr>
								<th>Sr.No</th>
							...
							{
								++ii;
								String staff_id=insurance.getAdded_by();
								HashMap<String,String> fSDetails=gf.getStaffDetails(staff_id);
							%>
							<tr>
								<td><%=ii%></td>
						...
						<hr style="background-color: black;" />
						<h6 style="color: purple;">Finance Details</h6>
						<table class="table">
							<tr>
								<th>Sr.No</th>
							...
							<tr>
								<td><%=i1%></td>
								<td><%=finance.getFinanceDuration()%><br /></td>
						...
						<h6>
							<a class="btn btn-danger"
								href="AddBikeDetails?bid=<%=b_id%>&sts=r">Click Here for
								Not-Available</a>
						</h6>
						<br />
					</div>
