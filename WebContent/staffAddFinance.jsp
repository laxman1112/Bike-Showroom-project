...
<body onload="blink()">
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h2 align="center" style="color: purple;">Add /Remove Finance
				Offers Details</h2>
			<hr />
					...
					<div class="row">
						...
						<table class="table">
							...
							<tr>
								...
								<td><%=fSDetails.get("staff_name")%><br /> Mb.<%=fSDetails.get("mobile")%>
								</td>
								<td><a
									href="AddFinancialsOffers?id=<%=finance.getfId()%>&bid=<%=finance.getBikeId()%>">Remove</a></td>
							</tr>
							<%
							}
							if(i1<=0)
			...
			<div class="col-lg-5">
				<div class="bordered-div">
					<h2 align="center">Finance Details</h2>
					<hr />
					<div class="table-responsive">
						<form action="AddFinancialsOffers" method="post">
							<table class="table">
								<tr>
									...
									<td><input type="hidden" name="bike_id"
										...
										placeholder="Enter Finance Duration">
								</tr>
								<tr>
									<th>Rate of Intrest</th>
									<td><input type="text" class="form-control"
										name="rate_intrest" placeholder="Enter Rate of Intrest">
								<tr>
									<th></th>
									<td><button type="submit" class="btn btn-success">Add
											Finance Offer</button></td>
								</tr>
							</table>
						</form>
					</div>
