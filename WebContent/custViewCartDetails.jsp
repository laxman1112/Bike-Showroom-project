...
<body>
	...
	<div class="container" style="margin-top: 0%;">
		<div class="row">
			<h1 style="color: purple;" align="center">Customer View Cart
				Details Details</h1>
			<div class="col-lg-12">
				<hr />
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<%
							...
							PreparedStatement ps =con.prepareStatement("SELECT * FROM `selling_details` where cust_id='"+c_id+"'");
							...
							HashMap<String,String> insuranceDetails=gf.getInsutanceDetails(insurance_id);
							HashMap<String,String> financeDetails=gf.getFinanceDetails(finance_sts);
						...
						<tbody>
							<tr>
								<td><%=i%></td>
								<td><img alt=""
									src="bike_photos/<%=bikeDetails.get("bike_photo")%>"
								...
								<%-- <td>
								<%
								if(insuranceDetails.get("insurance_name")!=null)
								{
									

								%>
								
								<%=insuranceDetails.get("insurance_name")%><br />[<%=insuranceDetails.get("rate_intrest")%>]<br/>
								Duration: <%=insuranceDetails.get("duration")%><br />
								...
								<td>
								<%
								if(financeDetails.get("finance_duration")!=null)
								{
									String addedd_by=financeDetails.get("addedd_by");
									HashMap<String,String> staffDetails=gf.getStaffDetails(addedd_by);
								%>
								
									<%=financeDetails.get("finance_duration")%><br />[<%=financeDetails.get("rate_intrest")%>]<br/>
										<%=staffDetails.get("staff_name")%><br/>
										Mb: <%=staffDetails.get("mobile")%><br />
								<%} %>
								</td>
 --%>
								<td><%=status %></td>
