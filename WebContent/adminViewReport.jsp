					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><%=rs.getString("staff_name") %><br /> Gender: <%=rs.getString("gender") %></td>
								<td>Mb. <%=rs.getString("mobile") %><br /> Email: <%=rs.getString("email") %></td>
								<td><%=rs.getString("address") %></td>
								<td><%=rs.getString("acc_status") %></td>
								<td>
									<%
							if(rs.getString("acc_status").equals("Available"))
							{
							%> <a style="color: red;"
									href="UpdateStaff?sts=na&id=<%=staff_id%>">Not-Available</a> <%
							}else
							{	
							%> <a style="color: red;"
									href="UpdateStaff?sts=a&id=<%=staff_id%>">Available</a> <%
							}
								%>
								</td>
